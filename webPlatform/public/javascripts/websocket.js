function Device(uid,token){  //create an object to device
...
function Connection(devicehost,callback){ //create an object to the websocket
   ...
   Device.prototype.connect = function(deviceHost){
     var me = this;
   ...
   Device.prototype.read = function(deviceHost){
        var me = this;
        //console.log("read?");
   ...
   Device.prototype.write = function(deviceHost,name,did){
        var me = this;
       // console.log(name);
   ...
   // console.log("websocket"+JSON.stringify(websocket) );
    ...
    if(isOnline==false){
        ...
        picToChangeS.src = "/images/schedule_gris.png";
        ...
        var picToChangeHeatzy = window.document.getElementById(didR+"|heatzy");
        picToChangeHeatzy.src = "/images/heatzy_gris.png";
        var picToChangeHeatzy = window.document.getElementById(didR+"|heatzyZone");
        picToChangeHeatzy.src = "/images/heatzyZone_gris.png";
    }
    else{
        var picToChangeS = window.document.getElementById(did+"|schedule");
    ...
    switch(programmation){
        ...
        if(picToChange !== null){picToChange.style.opacity = 0;}
        
        break;
        case 1:
        var picToChange = window.document.getElementById(didR+"|schedule");
        if(picToChange !== null){picToChange.style.opacity = 1;}
    ...
    switch(lock){
        ...
        if(picToChange !== null){picToChange.src = "/images/lock_gris.png";}
        
        break;
        case 1:
        var picToChange = window.document.getElementById(didR+"|lock_switch");
        if(picToChange !== null){ picToChange.src = "/images/lock_vert.png";}
    ...
    switch(vacances){
        ...
        case 1:
        var picToChange = window.document.getElementById(didR+"|derog_mode");
        if(picToChange !== null){picToChange.src = "/images/vacances_vert.png";}
        
        break;
    }
    switch(modeR){
    case "cft": 
    var picToChangeHeatzyZone = window.document.getElementById(didR+"|heatzyZone");
    if(picToChangeHeatzyZone !== null){
        picToChangeHeatzyZone.src = "/images/heatzyZone_vert.png";
    }
 //var deviceChangec = window.document.getElementById(didR+"|cft");
   ...
   // console.log(picToChangec.name);
    ...
    picToChangeStop.src = "/images/stop_vert.png";
    var picToChangeHeatzy = window.document.getElementById(didR+"|heatzy");
    picToChangeHeatzy.src = "/images/heatzy_vert.png";
    break;
    case "eco":
    var picToChangeHeatzyZone = window.document.getElementById(didR+"|heatzyZone");
    if(picToChangeHeatzyZone !== null){
...
var reqData = [];
var reqDataGroup = [];
for (var i = 0; i < deviceID.length; i++) { //differ group did
     reqData.push({ did: deviceID[i]});
    // console.log(JSON.stringify( reqData[i]))
}
...
Device.prototype._sendError = function(msg) {
if (this.onError) {
    this.onError(msg);
}
};
